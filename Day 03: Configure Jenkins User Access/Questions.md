...
2. Create a jenkins user named kareem with the passworddCV3szSGNA. Their full name should match Kareem.
...
5. For the existing job, grant kareem user only read permissions, disregarding other permissions such as Agent, SCM etc. Note:
